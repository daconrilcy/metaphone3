...
bool Encode_Silent_L_In_LK_LV(Metaphone3 *ctx)
{
    ...
    if ((StringAt(w, (m_current - 2), 4, "WALK", "YOLK", "FOLK", "HALF", "TALK", "CALF", "BALK", "CALK", "") ||
         (StringAt(w, (m_current - 2), 4, "POLK", "") && !StringAt(w, (m_current - 2), 5, "POLKA", "WALKO", "")) ||
         (StringAt(w, (m_current - 2), 4, "HALV", "") && !StringAt(w, (m_current - 2), 5, "HALVA", "HALVO", "")) ||
         (StringAt(w, (m_current - 3), 5, "CAULK", "CHALK", "BAULK", "FAULK", "") &&
          !StringAt(w, (m_current - 4), 6, "SCHALK", "")) ||
         (StringAt(w, (m_current - 2), 5, "SALVE", "CALVE", "") || StringAt(w, (m_current - 2), 6, "SOLDER", ""))
