...
bool Test_Silent_R(Metaphone3 *ctx)
{
    ...
    if (((m_current == m_last)
         ...
         && (StringAt(w, (m_current - 5), 3, "MET", "VIV", "LUC", "")
             // e.g. "cartier", "bustier"
             || StringAt(w, (m_current - 6), 4, "CART", "DOSS", "FOUR", "OLIV", "BUST", "DAUM", "ATEL",
                         "SONN", "CORM", "MERC", "PELT", "POIR", "BERN", "FORT", "GREN",
                         "SAUC", "GAGN", "GAUT", "GRAN", "FORC", "MESS", "LUSS", "MEUN",
                         "POTH", "HOLL", "CHEN", "")
             // e.g. "croupier"
             || StringAt(w, (m_current - 7), 5, "CROUP", "TORCH", "CLOUT", "FOURN", "GAUTH", "TROTT",
                         "DEROS", "CHART", "")
             // e.g. "chevalier"
             || StringAt(w, (m_current - 8), 6, "CHEVAL", "LAVOIS", "PELLET", "SOMMEL", "TREPAN", "LETELL", "COLOMB", "") ||
