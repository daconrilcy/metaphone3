...
bool Encode_Greek_CH_Initial(Metaphone3 *ctx)
{
    ...
    bool found =
        StringAt(w, cur, 6, "CHAMOM", "CHARAC", "CHARIS", "CHARTO", "CHARTU", "CHARYB", "CHRIST", "CHEMIC", "CHILIA", "") ||

        // Exclure "CHEMIN", "ANCHONDO"
        (StringAt(w, cur, 5, "CHEMI", "CHEMO", "CHEMU", "CHEMY", "CHOND", "CHONA", "CHONI", "CHOIR", "CHASM",
                  "CHARO", "CHROM", "CHROI", "CHAMA", "CHALC", "CHALD", "CHAET", "CHIRO", "CHILO", "CHELA",
                  "CHOUS", "CHEIL", "CHEIR", "CHEIM", "CHITI", "CHEOP", "") &&
        ...
        (StringAt(w, cur, 4, "CHOR", "CHOL", "CHYM", "CHYL", "CHLO", "CHOS", "CHUS", "CHOE", "") &&
         !StringAt(w, 0, 6, "CHOLLO", "CHOLLA", "CHORIZ", "")) ||

        (StringAt(w, cur, 4, "CHAO", "") && ((cur + 3) != last)) ||

        (StringAt(w, cur, 4, "CHIA", "") && !(StringAt(w, 0, 10, "APPALACHIA", "") || StringAt(w, 0, 7, "CHIAPAS", ""))) ||
