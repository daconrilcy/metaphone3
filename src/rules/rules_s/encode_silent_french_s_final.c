...
bool Encode_Silent_French_S_Final(Metaphone3 *ctx)
{
    ...
    if ((m_current == m_last) &&
            (StringAt(w, 0, 4, "YVES", "") ||
             ...
             StringAt(w, (m_current - 5), 6, "MESNES", "DEBRIS", "BLANCS", "INGRES", "CANNES", "") ||
             StringAt(w, (m_current - 6), 7, "CHABLIS", "APROPOS", "JACQUES", "ELYSEES", "OEUVRES", "GEORGES", "DESPRES", "") ||
             StringAt(w, 0, 8, "ARKANSAS", "FRANCAIS", "CRUDITES", "BRUYERES", "") ||
             StringAt(w, 0, 9, "DESCARTES", "DESCHUTES", "DESCHAMPS", "DESROCHES", "DESCHENES", "") ||
