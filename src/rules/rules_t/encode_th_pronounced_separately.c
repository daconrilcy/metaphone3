...
bool Encode_TH_Pronounced_Separately(Metaphone3 *ctx) {
  ...
  if (((m_current > 0) &&
       StringAt(w, (m_current + 1), 4, "HOOD", "HEAD", "HEID", "HAND", "HILL",
                "HOLD", "HAWK", "HEAP", "HERD", "HOLE", "HOOK", "HUNT", "HUMO",
                "HAUS", "HOFF", "HARD", "") &&
       !StringAt(w, (m_current - 3), 5, "SOUTH", "NORTH", "")) ||
      StringAt(w, (m_current + 1), 5, "HOUSE", "HEART", "HASTE", "HYPNO",
               "HEQUE", "")
      // watch out for greek root "-thallic"
      || (StringAt(w, (m_current + 1), 4, "HALL", "") &&
          ((m_current + 4) == m_last) &&
          !StringAt(w, (m_current - 3), 5, "SOUTH", "NORTH", "")) ||
      ...
      (StringAt(w, (m_current + 1), 5, "HATCH", "") &&
       !((m_current == 0) ||
         StringAt(w, (m_current - 2), 8, "UNTHATCH", ""))) ||
