...
bool Encode_GER(Metaphone3 *ctx) {
  ...
  if ((m_current > 0) && StringAt(w, (m_current + 1), 2, "ER", "")) {
    ...
    // e.g. "JAGER", "TIGER", "LIGER", "LAGER", "LUGER", "AUGER", "EAGER",
    // "HAGER", "SAGER"
    if ((((m_current == 2) && IsVowel(CharAt(w, (m_current - 1))) &&
              !IsVowel(CharAt(w, (m_current - 2))) &&
              !(StringAt(w, (m_current - 2), 5, "PAGER", "WAGER", "NIGER",
                         "ROGER", "LEGER", "CAGER", "")) ||
          StringAt(w, (m_current - 2), 5, "AUGER", "EAGER", "INGER", "YAGER",
                   "")) ||
         StringAt(w, (m_current - 3), 6, "SEEGER", "JAEGER", "GEIGER", "KRUGER",
                  "SAUGER", "BURGER", "MEAGER", "MARGER", "RIEGER", "YAEGER",
                  "STEGER", "PRAGER", "SWIGER", "YERGER", "TORGER", "FERGER",
                  "HILGER", "ZEIGER", "YARGER", "COWGER", "CREGER", "KROGER",
                  "KREGER", "GRAGER", "STIGER", "BERGER", "")
         // 'berger' but not 'bergerac'
         || (StringAt(w, (m_current - 3), 6, "BERGER", "") &&
             ((m_current + 2) == m_last)) ||
         StringAt(w, (m_current - 4), 7, "KREIGER", "KRUEGER", "METZGER",
         ...
         StringAt(w, (m_current - 5), 8, "SCHWAGER", "LYBARGER", "SPRENGER",
                  "GALLAGER", "WILLIGER", "") ||
        ...
        !(StringAt(w, (m_current - 5), 10, "BELLIGEREN", "") ||
          StringAt(w, 0, 7, "MARGERY", "") ||
          StringAt(w, (m_current - 3), 8, "BERGERAC", ""))) {
