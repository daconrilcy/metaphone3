...
bool Encode_NGER(Metaphone3 *ctx) {
  ...
  if ((m_current > 1) && StringAt(m_inWord, (m_current - 1), 4, "NGER", "")) {
    ...
    // 'orangery', 'granger' 'boulanger', 'challenger', 'danger', 'changer',
    // 'harbinger', 'lounger', 'ginger', 'passenger' except for these the
    // following
    if (!(RootOrInflections(m_inWord, "ANGER") ||
          ...
          (StringAt(m_inWord, (m_current - 3), 4, "HUNG", "FING", "BUNG",
                    "WING", "RING", "DING", "ZENG", "ZING", "JUNG", "LONG",
                    "PING", "CONG", "MONG", "BANG", "GANG", "HANG", "LANG",
                    "SANG", "SING", "WANG", "ZANG", "")
           // exceptions to above where 'G' => J
           &&
           !(StringAt(m_inWord, (m_current - 6), 7, "BOULANG", "SLESING",
                      "KISSING", "DERRING", "") ||
          ...
          StringAt(m_inWord, (m_current - 3), 6, "WENGER", "MUNGER", "SONGER",
                   "KINGER", "") ||
          StringAt(m_inWord, (m_current - 4), 7, "FLINGER", "SLINGER",
                   "STANGER", "STENGER", "KLINGER", "CLINGER", "") ||
          StringAt(m_inWord, (m_current - 5), 8, "SPRINGER", "SPRENGER", "") ||
          StringAt(m_inWord, (m_current - 3), 7, "LINGERF", "") ||
          StringAt(m_inWord, (m_current - 2), 7, "ANGERLY", "ANGERBO",
                   "INGERSO", ""))) {
