        ...
        if (((m_current > 1) &&
             ((StringAt(w, (m_current - 1), 1, "I", "U", "E", "") ||
              ...
              && !(StringAt(w, (m_current + 2), 5, "ATION", "") ||
                   ...
                   StringAt(w, (m_current - 2), 5, "LIGNI", "LIGNO", "REGNA", "DIGNI", "WEGNE", "TIGNE", "RIGNE", "REGNE", "TIGNO", "") ||
            ...
            || (((m_current + 2) == m_last) && StringAt(w, m_current, 3, "GNE", "GNA", "") && !StringAt(w, (m_current - 2), 5, "SIGNA", "MAGNA", "SIGNE", "")))
        {
