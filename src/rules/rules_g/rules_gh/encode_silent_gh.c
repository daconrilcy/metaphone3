...
bool Encode_Silent_GH(Metaphone3 *ctx)
{
    ...
    if (((((m_current > 1) &&
           StringAt(w, (m_current - 2), 1, "B", "H", "D", "G", "L", ""))
          // e.g., 'bough'
          || ((m_current > 2) &&
              StringAt(w, (m_current - 3), 1, "B", "H", "D", "K", "W", "N", "P",
                       "V", "") &&
              !StringAt(w, 0, 6, "ENOUGH", ""))
          // e.g., 'broughton'
          ...
          ((m_current > 0)
           // 'sigh', 'light'
           && ((CharAt(w, (m_current - 1)) == 'I') ||
               StringAt(w, 0, 4, "PUGH", "")
               // e.g. 'MCDONAGH', 'MURTAGH', 'CREAGH'
               || (StringAt(w, (m_current - 1), 3, "AGH", "") &&
                   ((m_current + 1) == m_last)) ||
               StringAt(w, (m_current - 4), 6, "GERAGH", "DRAUGH", "") ||
               (StringAt(w, (m_current - 3), 5, "GAUGH", "GEOGH", "MAUGH", "") &&
                !StringAt(w, 0, 9, "MCGAUGHEY", ""))
               // exceptions to 'tough', 'rough', 'lough'
               || (StringAt(w, (m_current - 2), 4, "OUGH", "") && (m_current > 3) &&
                   !StringAt(w, (m_current - 4), 6, "CCOUGH", "ENOUGH", "TROUGH", "CLOUGH", "")))))
         ...
         && (StringAt(w, (m_current - 3), 5, "VAUGH", "FEIGH", "LEIGH", "") ||
             ...
             (StringAt(w, (m_current + 2), 2, "IE", "EY", "ES", "ER", "ED", "TY",
                       "") &&
              ((m_current + 3) == m_last) &&
              !StringAt(w, (m_current - 5), 9, "GALLAGHER", "")) ||
             (StringAt(w, (m_current + 2), 1, "Y", "") &&
              ((m_current + 2) == m_last)) ||
             (StringAt(w, (m_current + 2), 3, "ING", "OUT", "") &&
              ((m_current + 4) == m_last)) ||
             (StringAt(w, (m_current + 2), 4, "ERTY", "") &&
              ((m_current + 5) == m_last)) ||
             (!IsVowel(CharAt(w, (m_current + 2))) ||
              StringAt(w, (m_current - 3), 5, "GAUGH", "GEOGH", "MAUGH", "") ||
              StringAt(w, (m_current - 4), 8, "BROUGHAM", ""))))
