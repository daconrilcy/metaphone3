...
bool IsVowel(char inChar) {
  ...
  if ((inChar == 'A') || (inChar == 'E') || (inChar == 'I') ||
      ...
      (inChar == 'Ŕ') || (inChar == 'Á') || (inChar == 'Â') ||
      (inChar == 'Ă') || (inChar == 'Ä') || (inChar == 'Ĺ') ||
      (inChar == 'Ć') || (inChar == 'Č') || (inChar == 'É') ||
      (inChar == 'Ę') || (inChar == 'Ë') || (inChar == 'Ě') ||
      (inChar == 'Í') || (inChar == 'Î') || (inChar == 'Ď') ||
      (inChar == 'Ň') || (inChar == 'Ó') || (inChar == 'Ô') ||
      (inChar == 'Ő') || (inChar == 'Ö') || (inChar == '?') ||
      (inChar == 'Ř') || (inChar == 'Ů') || (inChar == 'Ú') ||
      (inChar == 'Ű') || (inChar == 'Ü') || (inChar == 'Ý') ||
      (inChar == '?')) {
    return true;
  }
