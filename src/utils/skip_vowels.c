...
int SkipVowels(Metaphone3 *ctx, int at)
{
    ...
    {
        if (StringAt(w, at, 4, "WICZ", "WITZ", "WIAK", "") || StringAt(w, (at - 1), 5, "EWSKI", "EWSKY", "OWSKI", "OWSKY", "") || (StringAt(w, at, 5, "WICKI", "WACKI", "") && ((at + 4) == m_last)))
        {
            break;
        }
        ...
        if (((CharAt(w, at - 1) == 'W') && (CharAt(w, at) == 'H')) &&
            !(StringAt(w, at, 3, "HOP", "") ||
              StringAt(w, at, 4, "HIDE", "HARD", "HEAD", "HAWK", "HERD", "HOOK", "HAND", "HOLE", "") ||
